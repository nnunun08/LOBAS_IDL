...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td>
			<table width="1200" cellpadding="1" cellspacing="1" border="0" bgcolor=#DDDDDD>
				<tr height="28" bgcolor="#FFFFFF">
					<td style="padding: 5px;">
						[�ۼ����]<br>
						1. �� ȭ���� ����� �ιٽ� ����ڷ� �� �Ѱ�ǥ�� �ش� ������ �Է��մϴ�.<br>
						2. ����ڴ� �ιٽ�����  �Ѱ�ǥ�� �������Ϸ� �ٿ���� �� �ش� ���������� �ݾ��� �Է�(����/�ٿ��ֱ� )�մϴ�.<br>
						3. �ݾ��� �������� �Է��մϴ�.<br>
						4. �ݾ� �۷��� Enter key ������ �ڵ� ����˴ϴ�.
					</td>
				</tr>
					...
					<td>
						<table width=1600 cellspacing="1" cellpadding="0" bgcolor=#DDDDDD>
							...
							<tr bgcolor="f6f6f6" height="25">
								...
								<td align=center colspan=4>�ں�������</td>
								<td align=center colspan=4>�ڱݰ��</td>
							</tr>	
							...
							<tr bgcolor="FFFFFF" height="25">
								<td align=center rowspan=18>����(I)</td>
								<td align=center>��</td>
							...
							<tr bgcolor="FFFFFF" height="25">
								...
								<td align=center>- �������׿���</td>
								<td align=center><input type="text" class="suib" sub="1" col=7 row=12 size=10 value="<?=lobas_format($arr_fld[12][7])?>"></td>
								<td align=center><input type="text" class="suib" sub="1" col=8 row=12 size=10 value="<?=lobas_format($arr_fld[12][8])?>"></td>
								<td align=center><input type="text" class="suib" sub="1" col=9 row=12 size=10 value="<?=lobas_format($arr_fld[12][9])?>"></td>
							</tr>
							...
							<!-- ���� ���� ------------------------------------ -->
							<tr bgcolor="FFFFFF" height="25">
								<td align=center rowspan=19>����(II)</td>
								<td align=center>��</td>
							...
							<tr bgcolor="FFFFFF" height="25">
								<td align=center rowspan=6>����<br>(I - II)</td>

								<td align=center rowspan=6>��������<br>(�ں�����)</td>
								...
								<td align=center rowspan=6>�����̿�</td>
					...
					<td valign=top align=center>
						<table width=280 cellspacing="1" cellpadding="0" bgcolor=#DDDDDD>
							...
							<tr bgcolor="f6f6f6" height="50">
								<td align=center>�̼���/�̼�����</td>
								<td align=center>�����ޱ�/�����޺��</td>
							</tr>	
